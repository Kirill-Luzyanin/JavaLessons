...
public class Main {
    public static void main(String[] args) {
        ...
        Arrays.sort(persons); // comparable
        ...
        System.out.println("-------------------------");
        //System.out.println(persons[0].compareTo(persons[2]));

        Arrays.sort(persons,new PersonComparatorByAge()); // comparator
        System.out.println(Arrays.toString(persons));
        System.out.println("-------------------------");

        Arrays.sort(persons,new PersonComparatorByName2());
        System.out.println(Arrays.toString(persons));
        System.out.println("-------------------------");
