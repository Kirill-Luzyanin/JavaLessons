...
public class Main3 {
    ...
    /*
    14.
    Дан массив объектов Person(String name, int age). Написать метод, который сортирует
    данный массив по старшинству, от самого юного Person до самого взрослого.
