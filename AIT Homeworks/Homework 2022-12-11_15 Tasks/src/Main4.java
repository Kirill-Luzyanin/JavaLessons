...
public class Main4 {
    ...
    /*
    15.
    Дан массив объектов MyDDate(int day, int month, int year). Написать метод,
    который сортирует данный массив от самой ранней даты до самой поздней.
    Использовать любой известный вам алгоритм сортировки. Подсказка: естественно вам
    придется написать метод сравнения двух дат.
