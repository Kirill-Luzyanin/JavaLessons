...
Вам необходимо объединить задачи в очередь так, и написать метод getTask, чтобы
программист забирал задачи в порядке очереди, но, в первую очередь, задачи  “the boss said urgently”,
потом “high”, потом “low”. При этом важно, если есть несколько задач
например, “boss said urgently” они решаются в порядке очереди.
