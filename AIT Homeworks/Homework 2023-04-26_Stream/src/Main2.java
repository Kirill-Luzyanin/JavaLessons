...
Например: "Jack:room 10;Nick:room 20;Jack:room 1;Mike:room 3", "Jack" -> "room 1"
...
public class Main2 {
    public static void main(String[] args) {
        ...
        System.out.println(valueFromString("Jack:room 10;Nick:room 20;Jack:room 1;Mike:room 3", "Jack"));

    }

    public static String valueFromString(String string, String key) {
        if (string == null || key == null) return "_";
